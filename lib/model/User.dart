...
/*class User with ChangeNotifier {
  ...
  factory User.fromJson(Map<String, dynamic> parsedJson) {
    ...
    return User(
        ...
        height: parsedJson['height'] ?? 0.0,
        weight: parsedJson['weight'] ?? 0.0,
...
class User with ChangeNotifier {
  ...
  factory User.fromJson(Map<String, dynamic> parsedJson) {
    ...
    return User(
      ...
      carColor: parsedJson['carColor'] ?? '',
      language: parsedJson['language'] ?? '',
      height: (parsedJson['height'] as num?)?.toDouble(),
      weight: (parsedJson['weight'] as num?)?.toDouble(),
      health: parsedJson['health'] ?? '',
      education: parsedJson['education'] ?? '',
      carPictureURL: parsedJson['carPictureURL'] ?? '',
      inProgressOrderID: parsedJson['inProgressOrderID'],
  ...
  Map<String, dynamic> toJson() {
    Map<String, dynamic> json = {
      ...
      'location': this.location.toJson(),
      'shippingAddress': this.shippingAddress?.map((e) => e.toJson()).toList(),
      'role': this.role,
    ...
    if (inProgressOrderID != null) {
      json['inProgressOrderID'] = inProgressOrderID;
    }
    if (orderRequestData != null) {
      json['orderRequestData'] = orderRequestData?.toJson();
    }
    if (ordercabRequestData != null) {
      json['ordercabRequestData'] = ordercabRequestData?.toJson();
    }
    if (orderParcelRequestData != null) {
      json['orderParcelRequestData'] = orderParcelRequestData?.toJson();
    }
    if (carInfo != null) {
      json['carInfo'] = carInfo?.toJson();
    }
    return json;
